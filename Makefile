...
pkgdatadir = $(datadir)/navn
pkgincludedir = $(includedir)/navn
pkglibdir = $(libdir)/navn
pkglibexecdir = $(libexecdir)/navn
...
OBJEXT = o
PACKAGE = navn
PACKAGE_BUGREPORT = http://flux-net.net/bugs/
PACKAGE_NAME = Navn
PACKAGE_STRING = Navn 2.0.1
PACKAGE_TARNAME = navn
PACKAGE_URL = 
