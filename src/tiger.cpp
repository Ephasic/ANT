...
#define pass(a,b,c,mul) \
      t_round(a,b,c,x0,mul) \
      t_round(b,c,a,x1,mul) \
      t_round(c,a,b,x2,mul) \
      t_round(a,b,c,x3,mul) \
      t_round(b,c,a,x4,mul) \
      t_round(c,a,b,x5,mul) \
      t_round(a,b,c,x6,mul) \
      t_round(b,c,a,x7,mul)
...
#include "flux.h"
Flux::string TigerHash(const Flux::string &str)
{
    word64 res[3];
    char* string = const_cast<char*>(str.c_str());
    char* ret;
    tiger(reinterpret_cast<word64*>(string), strlen(string), res);
    sprintf(ret, "%08lX%08lX %08lX%08lX %08lX%08lX",
	(word32)(res[0]>>32),
	(word32)(res[0]),
	(word32)(res[1]>>32),
	(word32)(res[1]),
